...
export function HomePage(opts: { profile: DashboardProfile; user: NavUser; nonce: string; lv999?: boolean }) {
  const { profile } = opts;
  const { stats, pokemonCount, marriageBenefits, poopStats, poopProfile } = profile;
  ...
  const avgDailyPoops = Number.isFinite(avgDailyRaw) ? numSpan(avgDailyRaw, true) : 'N/A';
  const avgDurationRaw = Number(poopStats?.avgDuration);
  const avgPoopDuration = Number.isFinite(avgDurationRaw) ? `${Math.round(avgDurationRaw)} min` : 'N/A';
  ...
  const lastPoopDate = Number.isFinite(lastLoggedAtRaw)
    ...
    : null;
  const lastPoopAt =
    lastPoopDate && !Number.isNaN(lastPoopDate.getTime())
  ...
  const body = html`
    ...
    <div class="me-header">
      ...
      <div>
        ...
        <div class="me-id">
          <span class="status-led status-led-green" style="width:6px;height:6px;margin-bottom:1px;"></span>
          ${profile.discordId}
        </div>
      </div>
    </div>
      ...
      <div class="details-content">
        <div class="me-grid">
          ...
          <div class="me-card">
            ...
            <div class="value" style="font-size: 1.5rem; font-weight: 600;">${aiStatusLabel}</div>
            <div class="label" style="margin-top:0.25rem">${aiStatusDetail}</div>
          </div>
        </div>
      </div>
    </details>
    ...
    <details>
      ...
      <div class="details-content">
        <div class="me-grid">
          <div class="me-card">
            <div class="label">Ascension Level</div>
            <div class="value">Level ${stats.ascensionLevel ?? 0}</div>
          </div>
          <div class="me-card">
            <div class="label">Max Upgrade Level</div>
        ...
        <div class="me-grid">
          <div class="me-card">
            ...
            <div class="upgrade-info">
              ${renderUpgradeInfo(getMultiplierAmountInfo(stats.multiplierAmountLevel ?? 0, INFO_LEVEL.THIS_LEVEL))}
            </div>
          ...
          <div class="me-card">
            ...
            <div class="upgrade-info">
              ${renderUpgradeInfo(getMultiplierChanceInfo(stats.multiplierRarityLevel ?? 0, INFO_LEVEL.THIS_LEVEL))}
            </div>
          ...
          <div class="me-card">
            ...
            <div class="upgrade-info">
              ${renderUpgradeInfo(getBekiCooldownInfo(stats.bekiLevel ?? 0, INFO_LEVEL.THIS_LEVEL))}
            </div>
          ...
          <div class="me-card">
            ...
            <div class="upgrade-info">
              ${renderUpgradeInfo(getNuggieFlatMultiplierInfo(stats.nuggieFlatMultiplierLevel ?? 0, INFO_LEVEL.THIS_LEVEL))}
            </div>
          ...
          <div class="me-card">
            ...
            <div class="upgrade-info">
              ${renderUpgradeInfo(getNuggieStreakMultiplierInfo(stats.nuggieStreakMultiplierLevel ?? 0, INFO_LEVEL.THIS_LEVEL))}
            </div>
          ...
          <div class="me-card">
            ...
            <div class="upgrade-info">
              ${renderUpgradeInfo(getNuggieCreditsMultiplierInfo(stats.nuggieCreditsMultiplierLevel ?? 0, INFO_LEVEL.THIS_LEVEL))}
            </div>
          ...
          <div class="me-card">
            ...
            <div class="upgrade-info">
              ${renderUpgradeInfo(getNuggiePokeMultiplierInfo(stats.nuggiePokemonMultiplierLevel ?? 0, INFO_LEVEL.THIS_LEVEL))}
            </div>
          ...
          <div class="me-card">
            ...
            <div class="upgrade-info">
              ${renderUpgradeInfo(getNuggieNuggieMultiplierInfo(stats.nuggieNuggieMultiplierLevel ?? 0, INFO_LEVEL.THIS_LEVEL))}
            </div>
      ...
      <div class="details-content">
        <div class="me-grid">
          <div class="me-card">
            ...
            <div class="value">${claimStreak}</div>
            <div class="label" style="margin-top:0.25rem">days</div>
          </div>
          <div class="me-card">
            <div class="label">Base Claim Amount</div>
            <div class="value">${numSpan(5 + claimStreak)}</div>
            <div class="label" style="margin-top:0.25rem">5 + ${numSpan(claimStreak)}</div>
          </div>
          <div class="me-card">
            <div class="label">Streak Multiplier</div>
            <div class="value">${numSpanSuffix(1 + nuggieStreakMultiplier * claimStreak, 'x', true)}</div>
            <div class="label" style="margin-top:0.25rem">
              1 + ${numSpanSuffix(nuggieStreakMultiplier, 'x', true)} * ${numSpan(claimStreak)}
            </div>
          </div>
          <div class="me-card">
            <div class="label">Flat Multiplier</div>
            <div class="value">${numSpanSuffix(nuggieFlatMultiplier, 'x', true)}</div>
          </div>
          <div class="me-card">
            <div class="label">Marriage Multiplier</div>
            <div class="value">${numSpanSuffix(marriageBenefits, 'x', true)}</div>
          </div>
          <div class="me-card">
            <div class="label">Credits Multiplier</div>
            <div class="value">${numSpanSuffix(1 + nuggieCreditsMultiplier * log2Credits, 'x', true)}</div>
            <div class="label" style="margin-top:0.25rem">
              1 + ${numSpan(nuggieCreditsMultiplier, true)} * ${numSpan(log2Credits, true)}
            </div>
          </div>
          <div class="me-card">
            <div class="label">Pokemon Multiplier</div>
            <div class="value">${numSpanSuffix(1 + nuggiePokemonMultiplier * pokemonCount, 'x', true)}</div>
            <div class="label" style="margin-top:0.25rem">
              1 + ${numSpan(nuggiePokemonMultiplier, true)} * ${numSpan(pokemonCount, true)}
            </div>
          </div>
          <div class="me-card">
            <div class="label">Nuggie Multiplier</div>
            <div class="value">${numSpanSuffix(1 + nuggieNuggieMultiplier * log2Nuggies, 'x', true)}</div>
            <div class="label" style="margin-top:0.25rem">
              1 + ${numSpan(nuggieNuggieMultiplier, true)} * ${numSpan(log2Nuggies, true)}
            </div>
          </div>
          <div class="me-card">
            <div class="label">Next Claim</div>
            <div class="value" style="font-size: 1.1rem">${nextClaim}</div>
          </div>
        </div>
      </div>
    </details>
      ...
      <div class="details-content">
        ...
        <div class="me-grid">
          <div class="me-card">
            ...
            <div class="value">${stats.slotsTimesPlayed ?? 0}</div>
          </div>
          <div class="me-card">
            <div class="label">Times Won</div>
            <div class="value">${stats.slotsTimesWon ?? 0}</div>
          </div>
          <div class="me-card">
            <div class="label">Percentage Won</div>
            <div class="value">${pct(stats.slotsTimesWon ?? 0, stats.slotsTimesPlayed ?? 0)}</div>
          </div>
          <div class="me-card">
            <div class="label">Amount Gambled</div>
            <div class="value">${numSpan(sGambled)}</div>
          </div>
          <div class="me-card">
            <div class="label">Amount Won</div>
            <div class="value">${numSpan(sWon)}</div>
          </div>
          <div class="me-card">
            <div class="label">Net Winnings</div>
            <div class="value">${numSpan(sWon - sGambled)}</div>
          </div>
          <div class="me-card">
            <div class="label">Relative Amount Won</div>
            <div class="value">${numSpan(stats.slotsRelativeWon ?? 0, true)}</div>
            <div class="label" style="margin-top:0.25rem">bets</div>
          </div>
          <div class="me-card">
            <div class="label">Relative Net Winnings</div>
            <div class="value">${numSpan((stats.slotsRelativeWon ?? 0) - (stats.slotsTimesPlayed ?? 0), true)}</div>
            <div class="label" style="margin-top:0.25rem">bets</div>
          </div>
        </div>
        ...
        <div class="me-grid">
          <div class="me-card">
            <div class="label">Times Played</div>
            <div class="value">${bjTimesPlayed}</div>
          </div>
          <div class="me-card">
            <div class="label">Times Won</div>
            <div class="value">${bjTimesWon}</div>
          </div>
          <div class="me-card">
            <div class="label">Times Drew</div>
            <div class="value">${stats.blackjackTimesDrawn ?? 0}</div>
          </div>
          <div class="me-card">
            <div class="label">Times Lost</div>
            <div class="value">${bjTimesLost}</div>
          </div>
          <div class="me-card">
            <div class="label">Win Rate (Excl Draws)</div>
            <div class="value">${pct(bjTimesWon, bjTimesWon + bjTimesLost)}</div>
          </div>
          <div class="me-card">
            <div class="label">Amount Gambled</div>
            <div class="value">${numSpan(bjGambled)}</div>
          </div>
          <div class="me-card">
            <div class="label">Amount Won</div>
            <div class="value">${numSpan(bjWon)}</div>
          </div>
          <div class="me-card">
            <div class="label">Net Winnings</div>
            <div class="value">${numSpan(bjWon - bjGambled)}</div>
          </div>
          <div class="me-card">
            <div class="label">Relative Amount Won</div>
            <div class="value">${numSpan(stats.blackjackRelativeWon ?? 0, true)}</div>
            <div class="label" style="margin-top:0.25rem">bets</div>
          </div>
          <div class="me-card">
            <div class="label">Relative Net Winnings</div>
            <div class="value">${numSpan((stats.blackjackRelativeWon ?? 0) - bjTimesPlayed, true)}</div>
            <div class="label" style="margin-top:0.25rem">bets</div>
          </div>
          <div class="me-card">
            <div class="label">Current Streak</div>
            <div class="value">${stats.blackjackStreak ?? 0}</div>
          </div>
          <div class="me-card">
            <div class="label">Max Streak</div>
            <div class="value">${stats.blackjackMaxStreak ?? 0}</div>
          </div>
        </div>
        ...
        <div class="me-grid">
          <div class="me-card">
            <div class="label">Times Played</div>
            <div class="value">${stats.rouletteTimesPlayed ?? 0}</div>
          </div>
          <div class="me-card">
            <div class="label">Times Won</div>
            <div class="value">${stats.rouletteTimesWon ?? 0}</div>
          </div>
          <div class="me-card">
            <div class="label">Percentage Won</div>
            <div class="value">${pct(stats.rouletteTimesWon ?? 0, stats.rouletteTimesPlayed ?? 0)}</div>
          </div>
          <div class="me-card">
            <div class="label">Amount Gambled</div>
            <div class="value">${numSpan(rGambled)}</div>
          </div>
          <div class="me-card">
            <div class="label">Amount Won</div>
            <div class="value">${numSpan(rWon)}</div>
          </div>
          <div class="me-card">
            <div class="label">Net Winnings</div>
            <div class="value">${numSpan(rWon - rGambled)}</div>
          </div>
          <div class="me-card">
            <div class="label">Relative Amount Won</div>
            <div class="value">${numSpan(stats.rouletteRelativeWon ?? 0, true)}</div>
            <div class="label" style="margin-top:0.25rem">bets</div>
          </div>
          <div class="me-card">
            <div class="label">Relative Net Winnings</div>
            <div class="value">
              ${numSpan((stats.rouletteRelativeWon ?? 0) - (stats.rouletteTimesPlayed ?? 0), true)}
            </div>
            <div class="label" style="margin-top:0.25rem">bets</div>
          </div>
          <div class="me-card">
            <div class="label">Current Streak</div>
            <div class="value">${stats.rouletteStreak ?? 0}</div>
          </div>
          <div class="me-card">
            <div class="label">Max Streak</div>
            <div class="value">${stats.rouletteMaxStreak ?? 0}</div>
          </div>
        </div>
      </div>
    </details>
        ...
        ${
          totalPoops > 0
            ? html`
                <div class="me-grid">
                  <div class="me-card">
                    <div class="label">Total Poops</div>
                    <div class="value">${numSpan(totalPoops)}</div>
                  </div>
                  <div class="me-card">
                    <div class="label">Avg Daily Poops</div>
                    <div class="value">${avgDailyPoops}</div>
                  </div>
                  <div class="me-card">
                    <div class="label">Avg Duration</div>
                    <div class="value">${avgPoopDuration}</div>
                  </div>
                  <div class="me-card">
                    <div class="label">Most Common Type</div>
                    <div class="value" style="font-size: 1.1rem">${commonPoopType}</div>
                  </div>
                  <div class="me-card">
                    <div class="label">Most Common Colour</div>
                    <div class="value" style="font-size: 1.1rem">${commonPoopColour}</div>
                  </div>
                  <div class="me-card">
                    <div class="label">Last Poop</div>
                    <div class="value" style="font-size: 0.95rem">${lastPoopAt}</div>
                  </div>
                  <div class="me-card">
                    <div class="label">Timezone</div>
                    <div class="value">${poopTimezoneLabel}</div>
                  </div>
                </div>
              `
    ...
    <details>
      ...
      <div class="details-content">
        <div class="me-grid">
          <div class="me-card">
            <div class="label">Unique Pokemons Caught</div>
    ...
    <details>
      ...
      <div class="details-content">
        <div class="me-grid">
          <div class="me-card">
            <div class="label">Pity</div>
            <div class="value">${stats.pity ?? 0}</div>
          </div>
          <div class="me-card">
            <div class="label">Birthday</div>
            <div class="value" style="font-size: 1.1rem">${stats.birthdays ? stats.birthdays : 'No birthday set'}</div>
          </div>
        </div>
      </div>
    </details>
