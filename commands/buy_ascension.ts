...
class BuyAscension extends Command {
  ...
  async run(interaction: any): Promise<void> {
    ...
    const result = await processBuyAscensionUpgrade(this.client, interaction.user.id, upgradeId, amount);

    if (result.status === 'invalid_upgrade' || result.status === 'invalid_amount') {
      await interaction.editReply({
        embeds: [
          new Discord.EmbedBuilder().setColor('#AA0000').setTitle('Invalid upgrade').setFooter({ text: 'dinonuggie' }),
        ],
      });
      return;
    }
      ...
      await interaction.editReply({
        embeds: [
          new Discord.EmbedBuilder()
            ...
            .setDescription(
              `You need to be at least ascension ${result.required} to buy this upgrade. You are currently at ascension ${result.ascensionLevel}`,
            )
      ...
      await interaction.editReply({
        embeds: [
          new Discord.EmbedBuilder()
            ...
            .setDescription(
              `You have ${format(result.heavenlyNuggies)} heavenly nuggies, but you need ${format(result.cost)} to buy ${amount > 1 ? `${amount} upgrades` : 'the upgrade'}`,
            )
    ...
    const { upgrade, level, cost, heavenlyNuggies } = result;
        ...
        await interaction.editReply({
          embeds: [
            new Discord.EmbedBuilder()
              ...
              .setDescription(
                `${getNuggieFlatMultiplierInfo(level, INFO_LEVEL.NEXT_LEVEL, amount)}
${heavenlyAfter}`,
              )
              .setFooter({ text: 'dinonuggie' }),
          ],
        ...
        await interaction.editReply({
          embeds: [
            new Discord.EmbedBuilder()
              ...
              .setDescription(
                `${getNuggieStreakMultiplierInfo(level, INFO_LEVEL.NEXT_LEVEL, amount)}
${heavenlyAfter}`,
              )
              .setFooter({ text: 'dinonuggie' }),
          ],
        ...
        await interaction.editReply({
          embeds: [
            new Discord.EmbedBuilder()
              ...
              .setDescription(
                `${getNuggieCreditsMultiplierInfo(level, INFO_LEVEL.NEXT_LEVEL, amount)}
${heavenlyAfter}`,
              )
              .setFooter({ text: 'dinonuggie' }),
          ],
        ...
        await interaction.editReply({
          embeds: [
            new Discord.EmbedBuilder()
              ...
              .setDescription(
                `${getNuggiePokeMultiplierInfo(level, INFO_LEVEL.NEXT_LEVEL, amount)}
${heavenlyAfter}`,
              )
              .setFooter({ text: 'dinonuggie' }),
          ],
        ...
        await interaction.editReply({
          embeds: [
            new Discord.EmbedBuilder()
              ...
              .setDescription(
                `${getNuggieNuggieMultiplierInfo(level, INFO_LEVEL.NEXT_LEVEL, amount)}
${heavenlyAfter}`,
              )
              .setFooter({ text: 'dinonuggie' }),
          ],
