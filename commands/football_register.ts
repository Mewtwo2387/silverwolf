...
class FootballRegister extends DevCommand {
  constructor(client: any) {
    super(
      client,
      'register',
      'Register a channel for World Cup match announcements',
      [
        {
          name: 'channel',
  ...
  async run(interaction: any): Promise<void> {
    ...
    const added = await this.client.db.globalConfig.appendUniqueToList(FOOTBALL_CHANNELS_CONFIG_KEY, channel.id);
