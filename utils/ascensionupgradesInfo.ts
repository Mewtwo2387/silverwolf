import { INFO_LEVEL, type InfoLevel } from './upgradesInfo';
import {
...
function getNuggieFlatMultiplierInfo(level: number, infoLevel: InfoLevel, amount = 1): string {
...
function getNuggieStreakMultiplierInfo(level: number, infoLevel: InfoLevel, amount = 1): string {
...
function getNuggieCreditsMultiplierInfo(level: number, infoLevel: InfoLevel, amount = 1): string {
...
function getNuggiePokeMultiplierInfo(level: number, infoLevel: InfoLevel, amount = 1): string {
...
function getNuggieNuggieMultiplierInfo(level: number, infoLevel: InfoLevel, amount = 1): string {
