...
function adjustFontSize(ctx, lines, maxWidth, _fontSize) {
...
async function quote(
  ...
  const textColor = _textColor || (backgroundColor === 'white' ? 'black' : 'white');
  ...
  const lines = wrapText(ctx, message, maxWidth, fontSize);
  fontSize = adjustFontSize(ctx, lines, maxWidth, fontSize);
  ctx.font = `italic ${fontSize}px sans-serif`;
