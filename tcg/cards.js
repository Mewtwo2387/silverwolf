...
const KAITLIN = new Card(
  ...
  [
    new Skill('Unlimited Doge Works', 'Basic Attack when in Doge Form.', 5, 0, SkillEffectType.SINGLE_OPPONENT),
    new Skill('Slay Queen', 'Basic Attack when in Kaitlin Form.', 35, 0, SkillEffectType.SINGLE_OPPONENT),
    new Skill('Estrogen', 'Our girl finally goes through her transformation and becomes a girl. Converts into Kaitlin Form.', 0, 70, SkillEffectType.SELF, [
...
const VENFEI = new Card(
  ...
  new Background(BackgroundType.GRADIENT, { color1: '#D5ABB2', color2: '#B76E79' }, '#68343B', TopBarType.FADE, { color: '#440000', opacity1: 0.6, opacity2: 0.3 }),
  [
    new Skill('h', 'h', 5, 0, SkillEffectType.SINGLE_OPPONENT),
    new Skill('aaaaaaa', 'Increases outgoing damage of all allies by 30%', 0, 50, SkillEffectType.ALL_ALLIES, [
